    					...
    					<div class="tab-content clearfix">
    						<div class="tab-pane fade in active">
    							...
    							<div class="row">
									...
									<div class="row">
										<div class="col-lg-6 col-md-12">
											<h4>Facebook Commerce Product Catalog</h4>
											<small>Connect Commerce With This Link</small>
											<input type="text" class="form-control" value="{{url('/product/feed.csv')}}" readonly/>
										</div>
									</div>
    							</div>
    						</div>
