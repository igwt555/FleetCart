        ...
        <div class=" container">
            <div class="row">
                ...
                <div class="col-md-9 col-sm-18 text-right">
                        <img src="{{url('assets/images/payments.png')}}" width="300px"/>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    s1.async=true;
    s1.src='https://embed.tawk.to/61adfb6f80b2296cfdd03cbb/1fm7psbvf';
    s1.charset='UTF-8';
...
<a class="whatsapp-box" href="https://api.whatsapp.com/send?phone=062459488677"  data-bs-toggle="tooltip" data-bs-placement="left"  title="Contact Us">
    <img src="{{url('assets/images/whatsapp.png')}}" width="70px"/>
</a>
